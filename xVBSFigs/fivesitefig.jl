...
ED =open("/Users/alexjacoby/Documents/Julia_Code/xVBSFigs/ED_EE_5Site-FIG.txt") do file
     readdlm(file)
end

DMRG = open("/Users/alexjacoby/Documents/Julia_Code/xVBSFigs/DMRG_EE_5_SITE-FIG.txt") do file
     readdlm(file)
end

Analytic = open("/users/alexjacoby/Documents/Julia_Code/xVBSFigs/DMRG_EE_5_SITE-FIG.txt") do file
    readdlm(file)
end
...
plot!(X,Y2,  linewidth = 8,color = :red,label = "DMRG")
