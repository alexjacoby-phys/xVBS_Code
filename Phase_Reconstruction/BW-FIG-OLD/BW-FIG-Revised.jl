...
plot!(X[1],Y[1], xlabel = L"\theta",ylabel = L"{\rm Relative \ Entropy,} \ \mathcal{S}_{R}" ,seriestype = :scatter,color = GRAD[1] ,ytickfontsize = 10,xtickfontsize = 10,xguidefontsize = 20,yguidefontsize =15, fontfamily = "Times", label = Labels[1], legendfontsize = 15, legend = :right, markersize = 6)
