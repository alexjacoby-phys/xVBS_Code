...
#Ls = 10
#L = 2*Ls+1
Basis =([[1,2],[1,2]],[[1,3],[1,2]],[[1,4],[1,2]],[[2,3],[1,2]],[[2,4],[1,2]],[[3,4],[1,2]],[[1,2],[1,3]],[[1,3],[1,3]],[[1,4],[1,3]],[[2,3],[1,3]],[[2,4],[1,3]],[[3,4],[1,3]],[[1,2],[1,4]],[[1,3],[1,4]],[[1,4],[1,4]],[[2,3],[1,4]],[[2,4],[1,4]],[[3,4],[1,4]],[[1,2],[2,3]],[[1,3],[2,3]],[[1,4],[2,3]],[[2,3],[2,3]],[[2,4],[2,3]],[[3,4],[2,3]],[[1,2],[2,4]],[[1,3],[2,4]],[[1,4],[2,4]],[[2,3],[2,4]],[[2,4],[2,4]],[[3,4],[2,4]],[[1,2],[3,4]],[[1,3],[3,4]],[[1,4],[3,4]],[[2,3],[3,4]],[[2,4],[3,4]],[[3,4],[3,4]])
...
function RDM(a::Int64,b::Int64,c::Int64,d::Int64,e::Int64,f::Int64,g::Int64,h::Int64,α::Int64,β::Int64,μ::Int64,ν::Int64,N::Int64)
...
function RHO(LeftEdge::Vector{Float64},RightEdge::Vector{Float64},L::Int64)
    ...
    for α in 1:4, β in 1:4, μ in 1:4, ν in 1:4, i in 1:36, j in 1:36
        ...
        g = Basis[j][2][1]
        h = Basis[j][2][2]
        rho[α,β,μ,ν,i,j] = LeftEdge[μ]*RightEdge[ν]*LeftEdge[α]*RightEdge[β]*RDM(a,b,c,d,e,f,g,h,α,β,μ,ν,L)
    end
