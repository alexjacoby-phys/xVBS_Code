...
function SvN(dmat::Array{Float64,2})
...
LeftEdge = [1.,0,0,0]#normalize(2*rand(4)-ones(Float64,4))
RightEdge = [0,1.0,0,0]#normalize(2*rand(4)-ones(Float64,4))
...
print(SvN(RHO(LeftEdge,RightEdge,1,1)))

eigvals(RHO(LeftEdge,RightEdge,1,1))
